...
class Weather:
    ...
    def rain(self, entity, intensity=1):
        descriptions = {
        ...
        entity.weather_effect('rain', intensity=intensity)

    def rain_storm(self, entity, intensity=1):
        descriptions = {
        ...
        entity.weather_effect('rain_storm', intensity=intensity)

    def lightning(self, entity, frequency=1):
        descriptions = {
        ...
        entity.weather_effect('lightning', intensity=frequency)

    def fog(self, entity, density=1):
        descriptions = {
        ...
        entity.weather_effect('fog', intensity=density)

    def blizzard(self, entity, intensity=1):
        descriptions = {
        ...
        entity.weather_effect('blizzard', intensity=intensity)

    def sandstorm(self, entity, intensity=1):
        descriptions = {
        ...
        entity.weather_effect('sandstorm', intensity=intensity)

    def hurricane(self, entity, intensity=1):
        descriptions = {
        ...
        entity.weather_effect('hurricane', intensity=intensity)

    def heatwave(self, entity, intensity=1):
        descriptions = {
        ...
        entity.weather_effect('heatwave', intensity=intensity)

    def cold_snap(self, entity, severity=1):
        descriptions = {
        ...
        entity.weather_effect('cold_snap', intensity=severity)

    def dust_devil(self, entity, intensity=1):
        descriptions = {
        ...
        entity.weather_effect('dust_devil', intensity=intensity)

    def hailstorm(self, entity, intensity=1):
        descriptions = {
        ...
        entity.weather_effect('hailstorm', intensity=intensity)

    def sleet(self, entity, intensity=1):
        descriptions = {
        ...
        entity.weather_effect('sleet', intensity=intensity)

    def tornado(self, entity, intensity=1):
        descriptions = {
        ...
        entity.weather_effect('tornado', intensity=intensity)
