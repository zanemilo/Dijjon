...
import resources.core_library as cl  # Importing core library resources, aliased as 'cl'
import scripts.game_mechanics.Item as it  # Importing Item module from game mechanics, aliased as 'it'
